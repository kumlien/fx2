...
public class PriceInputParameter extends PriceHolder {
    ...
    public PriceInputParameter(final int flags, double[] o, double[] h, double[] l, double[] c, double[] v, double[] i) throws NullPointerException, IllegalArgumentException {
        super(o, h, l, c, v, i);
        initialize(flags);
    }
    ...
    /**
     * Returns the number of arrays expected to be returned by toArrays(). This
     * number is based on the flags passed during the construction of this
     * object.
     *
    ...
    /**
     * @return the arrays corresponding to the flags passed during construction
     * of this object.
     */
