...
public enum Operator implements BiFunction<Double, Double, Boolean> {
	LESS_THAN("<", (l, r) -> l < r),
    ...
    private Operator(final String symbol, final BiFunction<Double, Double, Boolean> biFunction) {
        this.symbol = symbol;
